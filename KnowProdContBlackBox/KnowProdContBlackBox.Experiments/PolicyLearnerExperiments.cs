...
namespace KnowProdContBlackBox.Experiments
{
    public class PolicyLearnerExperiments : Experiment
    {
        ...
        public void LogicOperations(int iterations)
        {
            ...
            //Save to files
            File.WriteAllText(Path.Combine(this.ResultsDir, "LogicOperations", iterations+"xorDetailed.html"), htmlTreeStyle + htmlVocab + htmlTree_BlanksSubScores);
            File.WriteAllText(Path.Combine(this.ResultsDir, "LogicOperations", iterations + "xorBlanks.html"), htmlTreeStyle + htmlVocab + htmlTree_Blanks);
            File.WriteAllText(Path.Combine(this.ResultsDir, "LogicOperations", iterations + "xorSimple.html"), htmlTreeStyle + htmlVocab + htmlTree_Simple);
